      ...
      <div className="max-w-[720px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 min-w-0 text-sm">
          <Link
            ...
            className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors shrink-0 truncate max-w-[120px]"
          >
        ...
        <span className="shrink-0 text-sm font-medium text-gray-400 dark:text-gray-500 tabular-nums">
