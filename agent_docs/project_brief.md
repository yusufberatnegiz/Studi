...
- **Constraints:** ASAP (1–2 weeks), Up to $50/month

## Workflow Expectations
- Always read `AGENTS.md` first
- Plan → Execute → Verify for every change
- Keep changes small and test after each feature

## Quality Gates
- `pnpm lint` passes
- `pnpm build` passes
- Manual end-to-end check for changed flow
